...
typedef UINT32(SSPI_GSSAPI* fn_sspi_gss_display_status)(UINT32* minor_status, UINT32 status_value,
...
typedef UINT32(SSPI_GSSAPI* fn_sspi_gss_compare_name)(UINT32* minor_status, sspi_gss_name_t name1,
...
typedef UINT32(SSPI_GSSAPI* fn_sspi_gss_inquire_context)(
    ...
    sspi_gss_name_t* targ_name, UINT32* lifetime_rec, sspi_gss_OID* mech_type, UINT32* ctx_flags,
    int* locally_initiated, int* open);

typedef UINT32(SSPI_GSSAPI* fn_sspi_gss_wrap_size_limit)(UINT32* minor_status,
                                                         sspi_gss_ctx_id_t context_handle,
                                                         int conf_req_flag, sspi_gss_qop_t qop_req,
                                                         UINT32 req_output_size,
                                                         UINT32* max_input_size);

typedef UINT32(SSPI_GSSAPI* fn_sspi_gss_import_name_object)(UINT32* minor_status, void* input_name,
                                                            sspi_gss_OID input_name_type,
                                                            sspi_gss_name_t* output_name);
...
typedef UINT32(SSPI_GSSAPI* fn_sspi_gss_export_sec_context)(UINT32* minor_status,
                                                            sspi_gss_ctx_id_t* context_handle,
                                                            sspi_gss_buffer_t interprocess_token);

typedef UINT32(SSPI_GSSAPI* fn_sspi_gss_import_sec_context)(UINT32* minor_status,
                                                            sspi_gss_buffer_t interprocess_token,
                                                            sspi_gss_ctx_id_t* context_handle);
...
typedef UINT32(SSPI_GSSAPI* fn_sspi_gss_str_to_oid)(UINT32* minor_status, sspi_gss_buffer_t oid_str,
                                                    sspi_gss_OID* oid);
...
typedef UINT32(SSPI_GSSAPI* fn_sspi_gss_inquire_mechs_for_name)(UINT32* minor_status,
...
typedef UINT32(SSPI_GSSAPI* fn_sspi_gss_seal)(UINT32* minor_status,
                                              sspi_gss_ctx_id_t context_handle, int conf_req_flag,
                                              int qop_req, sspi_gss_buffer_t input_message_buffer,
                                              int* conf_state,
                                              sspi_gss_buffer_t output_message_buffer);
...
static GSSAPI_FUNCTION_TABLE* SEC_ENTRY gssApi_InitSecurityInterface(void)
{
#ifdef WITH_GSSAPI
	return &g_GssApiLink;
#else
