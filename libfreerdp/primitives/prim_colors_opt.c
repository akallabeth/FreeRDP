...
#define d_mm_between_epi16(_val, _min, _max)                     \
	do                                                           \
	{                                                            \
