...
static int build_krbtgt(krb5_context ctx, krb5_data* realm, krb5_principal target)
{
	/* "krbtgt/" + realm + "@" + realm */
	...
	snprintf(name, len, "krbtgt/%s@%s", realm->data, realm->data);
