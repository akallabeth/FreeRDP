...
#elif defined(MSVC)
#define WINPR_PRAGMA_DIAG_PUSH __pragma warning(push)
...
#define WINPR_PRAGMA_DIAG_IGNORED_FORMAT_SECURITY
#define WINPR_PRAGMA_DIAG_TAUTOLOGICAL_CONSTANT_OUT_OF_RANGE_COMPARE \
	__pragma warning(disable : 4127) /** @since version 3.9.0 */
#define WINPR_PRAGMA_DIAG_TAUTOLOGICAL_VALUE_RANGE_COMPARE \
	__pragma warning(disable : 4127)                 /** @since version 3.10.0 */
...
#define WINPR_PRAGMA_DIAG_POP __pragma warning(pop)
#define WINPR_PRAGMA_UNROLL_LOOP __pragma loop(ivdep) /** @since version 3.6.0 */
#else
