...
static const ULONG G_SERCX_SYS_SUPPORTED_EV_MASK =
    SERIAL_EV_RXCHAR |
    /* SERIAL_EV_RXFLAG   | */
...
static BOOL s_set_wait_mask(WINPR_COMM* pComm, const ULONG* pWaitMask)
{
	...
	possibleMask = *pWaitMask & G_SERCX_SYS_SUPPORTED_EV_MASK;
...
static SERIAL_DRIVER g_SerCxSys = {
...
SERIAL_DRIVER* SerCxSys_s(void)
{
	...
	g_SerCxSys.set_baud_rate = pSerialSys->set_baud_rate;
	g_SerCxSys.get_baud_rate = pSerialSys->get_baud_rate;

	g_SerCxSys.get_properties = pSerialSys->get_properties;

	g_SerCxSys.set_serial_chars = pSerialSys->set_serial_chars;
	g_SerCxSys.get_serial_chars = pSerialSys->get_serial_chars;
	g_SerCxSys.set_line_control = pSerialSys->set_line_control;
	g_SerCxSys.get_line_control = pSerialSys->get_line_control;

	g_SerCxSys.set_timeouts = pSerialSys->set_timeouts;
	g_SerCxSys.get_timeouts = pSerialSys->get_timeouts;

	g_SerCxSys.set_dtr = pSerialSys->set_dtr;
	g_SerCxSys.clear_dtr = pSerialSys->clear_dtr;

	g_SerCxSys.set_rts = pSerialSys->set_rts;
	g_SerCxSys.clear_rts = pSerialSys->clear_rts;

	g_SerCxSys.get_modemstatus = pSerialSys->get_modemstatus;

	g_SerCxSys.set_wait_mask = pSerialSys->set_wait_mask;
	g_SerCxSys.get_wait_mask = pSerialSys->get_wait_mask;
	g_SerCxSys.wait_on_mask = pSerialSys->wait_on_mask;

	g_SerCxSys.set_queue_size = pSerialSys->set_queue_size;

	g_SerCxSys.purge = pSerialSys->purge;

	g_SerCxSys.get_commstatus = pSerialSys->get_commstatus;

	g_SerCxSys.set_break_on = pSerialSys->set_break_on;
	g_SerCxSys.set_break_off = pSerialSys->set_break_off;

	g_SerCxSys.set_xoff = pSerialSys->set_xoff;
	g_SerCxSys.set_xon = pSerialSys->set_xon;

	g_SerCxSys.get_dtrrts = pSerialSys->get_dtrrts;

	g_SerCxSys.immediate_char = pSerialSys->immediate_char;
