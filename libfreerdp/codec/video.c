...
/**
 * @brief Internal video frame structure (not exposed in public API)
 */
typedef struct
{
	FREERDP_VIDEO_FORMAT format;
	UINT32 width;
	UINT32 height;
...
static BOOL freerdp_video_fill_plane_info(BYTE* data[4], int lineSize[4], FREERDP_VIDEO_FORMAT format,
