...
/* Forward declaration of context structs.
 *
 * they contain circular references so it is necessary to split the typedefinition from the actual
 * struct definition
 */
...
typedef struct rdp_rdp rdpRdp;             /* Opaque */
