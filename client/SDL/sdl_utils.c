...
BOOL sdl_push_user_event(Uint32 type, ...)
{
	...
	switch (type)
	{
		case SDL_USEREVENT_AUTH_RESULT:
		{
			...
			arg->user = va_arg(ap, const char*);
			arg->domain = va_arg(ap, const char*);
			arg->password = va_arg(ap, const char*);
		...
		case SDL_USEREVENT_AUTH_DIALOG:
		{
			...
			arg->title = va_arg(ap, const char*);
			arg->user = va_arg(ap, const char*);
			arg->domain = va_arg(ap, const char*);
			arg->password = va_arg(ap, const char*);
			arg->result = va_arg(ap, Sint32);
		...
		{
			event->data1 = va_arg(ap, const char*);
			event->data2 = va_arg(ap, const char**);
