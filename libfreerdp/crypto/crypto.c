...
static SSIZE_T crypto_rsa_public(const BYTE* input, size_t length, size_t key_length,
...
static SSIZE_T crypto_rsa_private(const BYTE* input, size_t length, size_t key_length,
...
SSIZE_T crypto_rsa_public_encrypt(const BYTE* input, size_t length, size_t key_length,
                                  ...
                                  size_t out_length)
{
	return crypto_rsa_public(input, length, key_length, modulus, exponent, output, out_length);
}
