...
ExternalProject_Add(
  ...
  GIT_SHALLOW TRUE CONFIGURE_COMMAND ${CMAKE_COMMAND} -E copy_directory_if_different <SOURCE_DIR> <BINARY_DIR>
  BUILD_COMMAND make ${IOS_FLAGS} SHAREDLIB_DIR=@rpath LDFLAGS=-static-libstdc++ -j libraries
