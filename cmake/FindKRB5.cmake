...
if (PKG_CONFIG_FOUND)
    ...
    if (PC_KRB5_FOUND)
        set(KRB5_INCLUDE_DIR ${PC_KRB5_INCLUDE_DIRS})
        set(KRB5_LIBRARIES ${PC_KRB5_LIBRARIES})
        set(KRB5_LINK_DIRECTORIES ${PC_KRB5_LIBDIR})
        set(KRB5_LINKER_FLAGS ${PC_KRB5_LINKER_FLAGS})
        set(KRB5_COMPILER_FLAGS ${PC_KRB5_CFLAGS})
        set(KRB5_VERSION ${PC_KRB5_VERSION})
    endif()
endif()

if (NOT PC_KRB5_FOUND)
...
set(_KRB5_REQUIRED_VARS KRB5_LIBRARIES KRB5_INCLUDE_DIR)
