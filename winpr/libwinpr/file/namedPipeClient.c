...
static HANDLE_CREATOR g_NamedPipeClientHandleCreator;
...
{
	g_NamedPipeClientHandleCreator.IsHandled = IsNamedPipeFileNameA;
	g_NamedPipeClientHandleCreator.CreateFileA = NamedPipeClientCreateFileA;
	return &g_NamedPipeClientHandleCreator;
}
