...
#define RDPEAR_COMMON_MESSAGE_DECL(V)                                                            \
	...
	FREERDP_LOCAL NdrMessageType ndr_CreateApReqAuthenticatorResp_descr(void);
	...
	FREERDP_LOCAL NdrMessageType ndr_UnpackKdcReplyBodyResp_descr(void);
	...
	FREERDP_LOCAL NdrMessageType ndr_PackApReplyResp_descr(void);
